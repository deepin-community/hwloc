...
<tagfile doxygen_version="1.9.1">
  ...
  <compound kind="group">
    ...
    <member kind="function">
      ...
      <anchorfile>a00225.html</anchorfile>
      <anchor>ga3177cc0ab47e4dd1fa69ca1df4c7cb1a</anchor>
      <arglist>(hwloc_topology_t topology, hwloc_memattr_id_t attribute, struct hwloc_location *initiator, unsigned long flags, unsigned *nrp, hwloc_obj_t *targets, hwloc_uint64_t *values)</arglist>
    </member>
    <member kind="function">
      <type>int</type>
  ...
  <compound kind="page">
    ...
    <docanchor file="a00409.html" title="How do I enable ROCm SMI and select which version to use?">faq_cuda_build</docanchor>
